...
Pick one service from your team's platform (e.g., event ingestion, notification delivery, scheduled exports). Answer: What are its health signals? How would an operator know it's silently failing? What's the recovery procedure? What happens to upstream/downstream services when it's down? If you can't answer these, that's the gap.
