...
Pick one architectural decision facing your team (e.g., synchronous vs async for cross-service workflows, build vs buy for a notification service). Write a one-page decision document: context, options considered, recommendation, trade-offs, what you're giving up. Share it with a colleague and ask them to disagree with one specific point.
